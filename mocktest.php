...
<?php 
	...
	$question = $mqt->getQuesByNumber($number );
?>
<?php
...
<body>
		 ...
		 <div class="image">
          <div class="colmn">
          <img src="images/mock.jpg" width="150" height="150">
          </div>
            <div class="colmn">
     ...
     <div class="examnav">
             ...
             <a href="#"  style="color:white">Mock test</a> » 
               Mock test-random
              
            <a href="mockfinal.php"><span style="float:right;color:white">End test</span></div></a>
        </div>
<ul>
  <li>
    <?php echo "Time Left :" ?>
  ...
  setTimer(60, {
    10: function () { display("notifier", "Just 10 seconds to go"); },
     ...
     0: function () { display("notifier", "Time is up baby");       }
		...
		<div class="alamgir">
		<marquee>Your Quiz is Running</marquee></div>
		...
		<table> 
			...
			<tr>
			  <td>
				...
				<script>
				setTimeout(function() {
					window.location.href = "mocktest.php?q=<?php echo $question['quesNo']+1; ?>";
				...
				<script>
				setTimeout(function() {
					window.location.href = "mockfinal.php";
