...
<?php 
	...
	$question = $gqt->getQuesByNumber($number );
?>
<?php
		if($_SERVER['REQUEST_METHOD'] == 'POST'){
		$process = $Gpro->processData($_POST);
	}
?>
<html>
<head>
...
<body>
     <div class="image">
          ...
          <img src="images/img2.jpg" width="150" height="150">
            ...
            <div class="colmn">
          <span style="color:black;text-align:center;font-size:30px">Gk Test</span> 
           </div>
     </div>
     <div class="examnav">
             <a href="#" style="color:white;">Home</a> » 
             <a href="#" style="color:white;">Online Test</a> » 
             <a href="#" style="color:white;">gk test</a> » 
               Mock test-random
              
            <a href="gkfinal.php"><span style="float:right;color:white">End test</span></div></a>
        </div>

<ul>
  <li>  <?php echo "Time Left :" ?></li>
  <li>
		...
		<table> 
			...
			<tr>
			  <td>
				...
				<script>
				setTimeout(function() {
					window.location.href = "gktest.php?q=<?php echo $question['quesNo']+1; ?>";
				...
				<script>
				setTimeout(function() {
					window.location.href = "gkfinal.php";
